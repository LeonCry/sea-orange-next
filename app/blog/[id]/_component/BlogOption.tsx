...
export const BlogOption = () => {
  ...
  return (
    <>
      <Link
        className={`${style.exit} z-[9999] h-10 text-center absolute overflow-hidden top-[14px] left-4 cursor-none transition-all duration-500 py-1 w-24 rounded`}
        href={'/blog'}
      ...
      >
        <div
          ...
          } absolute transition-all duration-500 w-full text-center delay-100`}
        >
          EXIT
        </div>
        <div
